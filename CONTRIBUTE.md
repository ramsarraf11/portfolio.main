...
1. **Create a fork**
- Create a fork from this repository selecting (Ram Sarraf)[https://github.com/bbyc4kes] as the owner and then open your forked repo in your profile 
...
After the submission of your PR, if it's follows our convensions an Owner/Authorized admins will have a look at your PR and accept/reject with given feedback. You can expect to get a valuable feedback and more activity on your profile from an owner of this project [Ram Sarraf](https://github.com/bbyc4kes) and/or admins reviewing your PR :)
